product = {
    ...
    "invision": {"price": 5000, "name": "invision", "to_who": ["designer", "ui/ux"]},
    "zeplin": {"price": 4800, "name": "zeplin", "to_who": ["designer", "ui/ux"]},
    "balsamiq": {"price": 5300, "name": "balsamiq", "to_who": ["designer", "ui/ux"]},
    ...
    "marvel": {"price": 4600, "name": "marvel", "to_who": ["designer", "ui/ux"]},
    "framer": {"price": 6800, "name": "framer", "to_who": ["designer", "ui/ux"]},
    "origami_studio": {
        "price": 5000,
        "name": "origami_studio",
        "to_who": ["designer", "ui/ux"],
